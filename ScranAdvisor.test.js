...
describe('ScranAdvisor', () => {
    ...
    test('can find Happy Lamb Hot Pot restaurant by full name', () => {
        ...
        const actual = scranAdvisor.findByName("Happy Lamb Hot Pot"); // note works for Upper/Lower case
        expect(actual).toEqual(expected);
    })
    ...
    test('can find the name of all restaurants', () => {
        const expected = [
          ...
          const actual = scranAdvisor.returnAllName();
          expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.returnByLocation("Glasgow");
          expect(actual).toEqual(expected);
    })
